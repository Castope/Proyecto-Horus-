...
export default function AdminRegister() {
  ...
  return (
    <AdminAuthLayout
      eyebrow="Nuevo administrador"
      title="Crea tu acceso"
      description="Registra tus datos para comenzar a gestionar el contenido."
    >
      <div className="admin-auth__legacy-card">
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="nombre" style={{ display: 'block', marginBottom: 8, fontWeight: 600 }}>
              Nombre
            </label>
            <input
              id="nombre"
